...
export default function Register() {
  ...
  const carouselItems = [
    {
      ...
      description: "Join thousands of smart users managing their money effortlessly."
    },
    {
      title: (
        <>
      ...
      description: "Advanced analytics designed to give you clarity and confidence."
    },
    {
      title: (
        <>
      ...
      description: "No complex spreadsheets. Just intuitive, AI-powered design."
    }
  ];
  ...
  return (
    <div className="min-h-screen flex text-gray-900 bg-white font-sans">
      ...
      {/* Right Panel - Form */}
      <div className="w-full lg:w-[55%] flex flex-col justify-center px-6 py-10 lg:px-12 lg:py-6 overflow-y-auto">
        <div className="w-full max-w-md mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 mb-6 font-sans">Sign Up</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="group">
              ...
              {password && (
                <div className="mt-2 flex gap-1 h-1.5 animate-fade-in-up" style={{ animationDelay: '0s' }}>
                  {[1, 2, 3, 4].map((level) => (
                    <div 
                      key={level} 
                      className={`flex-1 rounded-full transition-colors duration-300 ${
                        strength >= level 
                          ? (strength <= 2 ? 'bg-amber-400' : strength === 3 ? 'bg-blue-400' : 'bg-emerald-500')
                          : 'bg-gray-200'
                      }`}
                    />
                  ))}
            ...
            <div className="group">
              ...
              <input
                ...
                className={`w-full px-4 py-2.5 rounded-xl border outline-none focus:ring-4 text-sm placeholder-gray-400 transition-all bg-gray-50 focus:bg-white ${
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 rounded-xl transition-all shadow-lg shadow-blue-500/30 text-sm disabled:opacity-70 flex justify-center items-center mt-6 transform active:scale-[0.98]"
            >
              {loading ? (
