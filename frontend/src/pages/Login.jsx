      ...
      <div className="hidden lg:flex lg:w-[48%] bg-white relative overflow-hidden flex-col justify-between p-12 border-r border-gray-100">
              ...
              <div className="absolute -bottom-4 -right-4 bg-white/80 backdrop-blur-md p-4 rounded-2xl shadow-xl border border-white/50 animate-float">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-[10px] text-gray-500 font-medium">Growth rate +12.5%</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="relative z-10 mt-12 flex items-center justify-between border-t border-gray-100 pt-8 text-xs text-gray-400 font-medium">
          <div className="flex items-center gap-4">
            <span className="flex items-center gap-1.5"><Shield size={14} className="text-gray-300"/> 256-bit Encryption</span>
            <span className="flex items-center gap-1.5"><Zap size={14} className="text-gray-300"/> Instant Setup</span>
          </div>
          <p>© 2024 Finova Inc.</p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-[52%] flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-[440px] animate-slide-in-up">
          ...
          <div className="mb-10 text-center lg:text-left">
            ...
            <p className="text-gray-500 font-medium">Log in to continue managing your finances</p>
          </div>

          {/* Social Logins */}
          <div className="grid grid-cols-2 gap-4 mb-8">
            <button className="flex justify-center items-center gap-3 px-4 py-3 border border-gray-200 rounded-2xl hover:bg-gray-50 transition-all text-sm font-bold text-gray-700 active:scale-[0.98] shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <input
                  ...
                  className="w-full px-5 py-4 rounded-2xl border border-gray-200 outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 text-base font-medium placeholder-gray-400 transition-all bg-gray-50/50 focus:bg-white pr-14"
                  required
                />
                <button
                  type="button"
            ...
            <div className="flex items-center gap-3 px-1 py-1">
              <label className="relative flex items-center cursor-pointer group">
                ...
                <span className="ml-3 text-sm text-gray-500 font-semibold group-hover:text-gray-900 transition-colors">Keep me logged in</span>
              </label>
            </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-100 flex flex-col items-center gap-4">
             ...
             <p className="text-[11px] text-gray-400 font-bold uppercase tracking-widest">Trusted by 50,000+ happy users</p>
          </div>
        </div>
      </div>
    </div>
